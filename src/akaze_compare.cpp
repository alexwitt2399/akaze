...
int ORB_WTA_K = 2;
cv::ORB::ScoreType ORB_HARRIS_SCORE = cv::ORB::HARRIS_SCORE; 
...
#else
  cv::Ptr<cv::ORB> orb = cv::ORB::create(ORB_MAX_KPTS, ORB_SCALE_FACTOR, ORB_PYRAMID_LEVELS, ORB_EDGE_THRESHOLD, ORB_FIRST_PYRAMID_LEVEL, ORB_WTA_K, ORB_HARRIS_SCORE, ORB_PATCH_SIZE);
#endif
